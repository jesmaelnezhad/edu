...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function initData() {
            ...
            document.getElementById("PayCallBackUrl").value = "http://localhost:8080/pgw-client-java-jaxws/callback.jsp";
    ...
    <tr>
        ...
        <td>
            <input type="text" name="TerminalId"
                   value="<%= (request.getParameter("TerminalId") != null) ? request.getParameter("TerminalId") : ""%>">
        </td>
    </tr>
    <tr>
        <td class="LabelTd">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="UserPassword"
                   value="<%= (request.getParameter("UserPassword") != null) ? request.getParameter("UserPassword") : ""%>">
        </td>
    </tr>
</table>
<hr/>
